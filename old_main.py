...
while True:
    ...
    for index, row in px.iterrows():
        ...
        if 'car' in c:
            ...
            cv2.putText(frame, str(c), (x1, y1), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 255, 255), 2)
    ...
    # Border2
    # cv2.line(frame,(179,cy2),(960,cy2),(255,255,255),1)
    # cv2.putText(frame, "Border2", (180, cy2), cv2.FONT_HERSHEY_COMPLEX, 0.8, (243, 250, 18), 2)
